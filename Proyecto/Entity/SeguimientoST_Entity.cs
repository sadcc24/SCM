...
namespace Entity
{
    class SeguimientoST_Entity
    {
        ...
        #region Constructor
        public  SeguimientoST_Entity()
        {
        }

        public SeguimientoST_Entity(int pcodVehiculo, string pMarca, string pLinea, string pMotor, string pColor, string pChasis, string pPlaca, string pModelo, int ptipovhc)
        {
