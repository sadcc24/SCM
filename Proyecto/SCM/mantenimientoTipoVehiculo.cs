...
namespace SCM
{
    public partial class mantenimientoTipoVehiculo : Form
    {
        public mantenimientoTipoVehiculo()
        {
            InitializeComponent();
        }

        private void mantenimientoTipoVehiculo_Load(object sender, EventArgs e)
        {
            tipo_vehiculo_BO prov = new tipo_vehiculo_BO();
        ...
        private void grdInventario_CellContentClick_1(object sender, DataGridViewCellEventArgs e)
        {
            ...
            TipoVehiculo frm = new TipoVehiculo();
